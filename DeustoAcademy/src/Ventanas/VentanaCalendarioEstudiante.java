...
public class VentanaCalendarioEstudiante extends JFrame {
	...
	class MyTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			 ...
			 * 
			 * switch (columnIndex) { case 0: return i.getIdioma(); case 1: return
			 * i.getIdioma(); case 2: return i.getIdioma(); default: return null; }
			 */
		}
	...
	class EditorCalendario extends AbstractCellEditor implements TableCellEditor {
		...
		//public void ComboAsiganturas() {
			...
			// ComboAsiganturas.setFont(new Font(currentFont.getName(),
			// currentFont.getStyle(), 9));
